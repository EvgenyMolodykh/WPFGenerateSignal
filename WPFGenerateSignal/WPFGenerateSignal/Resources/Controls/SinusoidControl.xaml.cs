...
{
    public partial class SinusoidControl : UserControl
    {
        ...
        private void OnViewModelPropertyChanged(object sender, PropertyChangedEventArgs e)
        {
                ...
                e.PropertyName == nameof(SignalViewModel.PointsCount))
            {
                ...
                System.Diagnostics.Debug.WriteLine($"Параметр {e.PropertyName} изменен, но график не перестроен");
            }
        ...
        {
            _plotModel = new PlotModel { Title = "Синусоида" };
            ...
            await Task.Run(() =>
            {
                try
                {
                    ...
                    for (int i = 0; i < pointsCount; i++)
                    {
                        ...
                        double value = amplitude * Math.Sin(TwoPI * frequency * animatedX + phase);
                ...
                catch (Exception ex)
                {
                    Application.Current.Dispatcher.Invoke(() =>
                    {
                        System.Diagnostics.Debug.WriteLine($"Ошибка генерации синусоиды: {ex.Message}");
                    });
                }
            }, cancellationToken);
        }
